...
<style>
	...
	.icon-check:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_users_components_verify_index_0.png");
	...
	.icon-close:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_users_components_verify_index_1.png");
		background-size: contain;
	}
	...
	.icon-right:before {
		...
		z-index: 9999;
		background-image: url("https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_users_components_verify_index_2.png");
		background-size: contain;
	}
	...
	.icon-refresh:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_users_components_verify_index_3.png");
		background-size: contain;
	}
</style>
