<template>
	<view style="position: relative">
		<view class="verify-image-out" v-show="showImage">
			<view class="verify-image-panel" :style="{ width: imgSize.width, height: imgSize.height, 'margin-bottom': vSpace + 'px' }">
		...
		<view class="verify-bar-area" :style="{ width: imgSize.width, color: barAreaColor, 'border-color': barAreaBorderColor, 'line-height': '40px' }">
...
.icon-check:before {
	...
	bottom: 0;
	z-index: 9999;
	background-image: url('https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_annex_components_verify_verifyPoint_verifyPoint_0.png');
...
.icon-close:before {
	...
	bottom: 0;
	z-index: 9999;
	background-image: url('https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_annex_components_verify_verifyPoint_verifyPoint_1.png');
	background-size: contain;
}
...
.icon-right:before {
	...
	z-index: 9999;
	background-image: url('https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_annex_components_verify_verifyPoint_verifyPoint_2.png');
	background-size: contain;
}
...
.icon-refresh:before {
	...
	bottom: 0;
	z-index: 9999;
	background-image: url('https://goyoto.oss-cn-beijing.aliyuncs.com/images/extracted/pages_annex_components_verify_verifyPoint_verifyPoint_3.png');
	background-size: contain;
}
</style>
