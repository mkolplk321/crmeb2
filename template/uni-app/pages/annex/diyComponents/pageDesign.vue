...
import userInfor from "@/components/diyComponents/userInfor.vue";
import homeUserInfor from "@/components/diyComponents/homeUserInfor.vue";
import newVip from "@/components/diyComponents/newVip.vue";
import articleList from "@/components/diyComponents/articleList.vue";
import bargain from "./bargain.vue";
import blankPage from "@/components/diyComponents/blankPage.vue";
import combination from "./combination.vue";
import coupon from "@/components/diyComponents/coupon.vue";
import customerService from "@/components/diyComponents/customerService.vue";
import goodList from "@/components/diyComponents/goodList.vue";
import guide from "./guide.vue";
import liveBroadcast from "./liveBroadcast.vue";
import menus from "@/components/diyComponents/menus.vue";
import news from "@/components/diyComponents/news.vue";
import pictureCube from "@/components/diyComponents/pictureCube.vue";
import promotionList from "@/components/diyComponents/promotionList.vue";
...
import signIn from "@/components/diyComponents/signIn.vue";
import hotspot from "@/components/diyComponents/hotspot.vue";
import follow from "@/components/diyComponents/follow.vue";
import productInfo from "@/components/diyComponents/productInfo.vue";
import homePaidVip from "@/components/diyComponents/homePaidVip.vue";
import homeProductService from "@/components/diyComponents/homeProductService.vue";
import homeReviews from "@/components/diyComponents/homeReviews.vue";
import productDesc from "@/components/diyComponents/productDesc.vue";
import customComponent from "@/components/diyComponents/customComponent.vue";
